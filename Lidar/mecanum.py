#!/usr/bin/python3
# coding=utf8
# éº¦å…‹çº³å§†è½®åº•ç›˜è¿�åŠ¨å­¦(Mecanum wheel chassis kinematic)
import math
from ros_robot_controller_msgs.msg import MotorState, MotorsState

class MecanumChassis:
    # wheelbase = 0.1368   # å‰�å�Žè½´è·�(distance between front and real axles)
    # track_width = 0.1446 # å·¦å�³è½´è·�(distance between left and right axles)
    # wheel_diameter = 0.065  # è½®å­�ç›´å¾„(wheel diameter)
    ...
    def set_velocity(self, linear_x, linear_y, angular_z):
        ...
        Use polar coordinates to control moving
                    x
        v1 motor1|  â†‘  |motor3 v3
          +  y - |     |
        v2 motor2|     |motor4 v4
        :param speed: m/s
        :param direction: Moving direction 0~2pi, 1/2pi<--- â†‘ ---> 3/2pi
